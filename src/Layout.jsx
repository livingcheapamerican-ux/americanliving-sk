          ...
          <div className="flex items-center justify-between gap-1 sm:gap-2">
            ...
            <div className="hidden sm:flex items-center gap-2 lg:gap-3">
              ...
              <a 
                ...
                className="hidden xl:flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold text-slate-700 dark:text-slate-200 hover:text-red-600 transition-colors"
              >
                <Phone className="w-3.5 h-3.5 text-red-600 animate-pulse" />
                <span>+421 948 111 222</span>
              </a>

              {/* Download Catalog Primary CTA */}
              <Link to={createPageUrl("StiahniteSiNasKatalog")} className="hidden md:inline-flex">
