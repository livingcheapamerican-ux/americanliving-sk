          ...
          <div className="p-3 border-b-2 border-slate-300 bg-slate-50">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-base font-black text-gray-900">{dom?.nazov || 'Barn Double 72m²'}</h3>
              </div>
            </div>
          </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 sm:gap-4">
                    ...
                    <div className="col-span-2 lg:col-span-1 p-3 sm:p-4 border-[3px] sm:border-[4px] border-amber-600 rounded-xl sm:rounded-2xl bg-gradient-to-br from-amber-50 to-amber-100/80 shadow-xl">
                      ...
                      <EditableTile
                        ...
                        title={t('assemblyYes')}
                        subtitle={t('phase1')}
                        price={`+ ${(9225).toLocaleString('sk-SK')} €`}
                        isPriced={true}
                        t={t}
                        isAdmin={isAdmin}
                        priceKey="montaz_ano"
                    ...
                    <div className="col-span-2 p-3 sm:p-4 border-[3px] sm:border-[4px] border-cyan-600 rounded-xl sm:rounded-2xl bg-gradient-to-br from-cyan-50 to-cyan-100/80 shadow-xl">
                      ...
                      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3">
                        ...
                        <EditableTile
                          ...
                          title="200/250mm"
                          subtitle="200/250mm"
                          price={`+ ${(2700).toLocaleString('sk-SK')} €`}
                          isPriced={true}
                          t={t}
                          isAdmin={isAdmin}
                        ...
                        <EditableTile
                          ...
                          title="250/300mm"
                          subtitle="250/300mm"
                          price={`+ ${(5400).toLocaleString('sk-SK')} €`}
                          isPriced={true}
                          isA0={true}
                          t={t}
                          isAdmin={isAdmin}
                        ...
                        <EditableTile
                          ...
                          price={`+ ${(10125).toLocaleString('sk-SK')} €`}
                          isPriced={true}
                          isA0={true}
                          t={t}
                          isAdmin={isAdmin}
                    ...
                    <div className="col-span-2 p-3 sm:p-4 border-[3px] sm:border-[4px] border-orange-600 rounded-xl sm:rounded-2xl bg-gradient-to-br from-orange-50 to-orange-100/80 shadow-xl">
                      ...
                      <EditableTile
                        ...
                        price={`+ ${(3400).toLocaleString('sk-SK')} €`}
                        isPriced={true}
                        t={t}
                        isAdmin={isAdmin}
                      ...
                      <EditableTile
                        ...
                        price={`+ ${(7500).toLocaleString('sk-SK')} €`}
                        isPriced={true}
                        t={t}
                        isAdmin={isAdmin}
                      ...
                      <EditableTile
                        ...
                        price={`+ ${(6500).toLocaleString('sk-SK')} €`}
                        isPriced={true}
                        t={t}
                        isAdmin={isAdmin}
                    ...
                    {setPredlzenie && (
                      <div className="col-span-1 sm:col-span-3 lg:col-span-4 p-1.5 sm:p-3 border-[2px] sm:border-[4px] border-indigo-600 rounded-lg sm:rounded-xl bg-indigo-100/70 shadow-xl">
                        <p className="text-[8px] sm:text-[10px] font-bold text-indigo-700 -mb-0.5 sm:-mb-1 flex items-center gap-0.5 sm:gap-1 mb-2">
                          <span className="w-3.5 h-3.5 sm:w-5 sm:h-5 bg-indigo-600 text-white rounded-full flex items-center justify-center text-[8px] sm:text-[10px] font-extrabold">+</span>
                          Predĺženie domu
                        </p>
                        <div className="grid grid-cols-2 sm:grid-cols-5 gap-1 sm:gap-2">
                          {[
                            { value: 0, label: "Bez predĺženia", price: 0 },
                            { value: 1.2, label: "+1,2 m", price: 6600 },
                            { value: 2.4, label: "+2,4 m", price: 13200 },
                            { value: 3.6, label: "+3,6 m", price: 19800 },
                            { value: 4.8, label: "+4,8 m", price: 26400 }
                          ].map((opt) => (
                            <EditableTile
                              key={opt.value}
