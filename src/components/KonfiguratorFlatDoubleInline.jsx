...
export default function KonfiguratorFlatDoubleInline({ 
  ...
  const CENY = useFlat15Prices ? {
    ...
    elektroinstalacia: 6660,
    vodaKanalizacia: 1963,
    sanitaKomplet: 1169,
    bojler: 264,
    tepelneCerpadlo: 5676,
    rekuperacia: 2736,
    zaklady: { bez: 0, skrutky: 8140, doska: 17946, pasove: 21079 },
    pripojkaSiete: 1501,
    inziniering: 2592,
    projektA0: 3500,
    interierFinis: { ziadne: 0, drevo: 14032, sadrokarton: 16126 },
    vonkajsiaFasada: { standard: 0, suchana: 10895 },
    povrchokaOkien: 2480,
    vnutornePodlahy: 2994,
    podlahovVykurovanie: 6772,
    pergola: 3155,
    interieroveDvere: 308,
    tonovaneSkla: 1197,
    doprava: 0,
    revizna: 1000,
    stresneOkno: 1300,
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-3">
            ...
            <div className="col-span-2 sm:col-span-3 grid grid-cols-3 gap-2 sm:gap-3 p-4 border-[5px] border-blue-600 rounded-2xl bg-blue-100/70 shadow-xl">
              ...
              <Tile
                ...
                price={useFlat15Prices ? "+ 12 700 €" : "+ 8 200 €"}
                isPriced={true}
              ...
              <Tile
                ...
                subtitle={t('plaster')}
                price={useFlat15Prices ? "+ 14 545 €" : "+ 9 430 €"}
                isPriced={true}
            ...
            <div className="col-span-2 sm:col-span-2 grid grid-cols-2 gap-2 sm:gap-3 p-4 border-[5px] border-yellow-500 rounded-2xl bg-yellow-100/70 shadow-xl">
              ...
              <Tile
                ...
                title={t('electrical')}
                subtitle={t('wiring')}
                price={useFlat15Prices ? "+ 5 200 €" : "+ 3 900 €"}
                isPriced={true}
              ...
              <Tile
                ...
                title={t('water')}
                subtitle={t('wiring')}
                price={useFlat15Prices ? "+ 2 100 €" : "+ 1 150 €"}
                isPriced={true}
                tooltip={t('waterFull')}
              />
              ...
              <div className="col-span-2 sm:col-span-2 lg:col-span-2 grid grid-cols-2 gap-2 sm:gap-3 p-4 border-[5px] border-green-600 rounded-2xl bg-green-100/70 shadow-xl">
                ...
                <Tile
                  ...
                  title={t('heatPump')}
                  subtitle={t('units5')}
                  price={useFlat15Prices ? "+ 4 428 €" : "+ 3 321 €"}
                  isPriced={true}
                  isA0={true}
                ...
                <Tile
                  ...
                  subtitle={t('units5')}
                  price={useFlat15Prices ? "+ 2 200 €" : "+ 1 600 €"}
                  isPriced={true}
                  isA0={true}
                  selectedBg="bg-green-100"
                  selectedBorder="border-green-500"
              ...
              <Tile
                ...
                price={useFlat15Prices ? "+ 2 400 €" : "+ 1 450 €"}
                isPriced={true}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-3">
            ...
            <div className={`col-span-2 grid grid-cols-2 gap-2 sm:gap-3 p-4 border-[5px] rounded-2xl shadow-xl ${!vonkajsiaFasada ? 'border-red-600 bg-red-100/70 animate-pulse' : 'border-emerald-600 bg-emerald-100/70'}`}>
              ...
              <Tile
                ...
                price={useFlat15Prices ? "+ 10 385 €" : "+ 6 371 €"}
                isPriced={true}
                selectedBg="bg-emerald-100"
                selectedBorder="border-emerald-500"
                selectedRing="ring-emerald-300"
            ...
            <Tile
              ...
              price={useFlat15Prices ? "+ 2 640 €" : "+ 1 750 €"}
              isPriced={true}
              selectedBg="bg-emerald-100"
              selectedBorder="border-emerald-500"
              selectedRing="ring-emerald-300"
            ...
            <Tile
              ...
              price={useFlat15Prices ? "+ 4 316 €" : "+ 3 960 €"}
              isPriced={true}
              selectedBg="bg-orange-100"
              selectedBorder="border-orange-500"
              selectedRing="ring-orange-300"
