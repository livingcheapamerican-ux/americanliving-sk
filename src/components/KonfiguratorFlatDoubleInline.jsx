        ...
        <Card className="overflow-hidden border-0 shadow-2xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 ring-2 ring-green-500/30">
          ...
          <div className="p-3 border-t border-slate-700/50">
            <details className="group">
              ...
              <div className="mt-2 text-[10px] text-slate-400 space-y-1 pl-5">
                ...
                <p className="text-red-400 mt-2">Maľovanie: 4,5 €/m²</p>
              </div>
            </details>
          </div>

          {/* Poznámky - Elektroinštalácia */}
          <div className="p-3 border-t border-slate-700/50">
            <details className="group">
              <summary className="flex items-center gap-2 cursor-pointer text-xs font-semibold text-yellow-400 hover:text-yellow-300">
              ...
              <div className="mt-2 text-[10px] text-slate-400 space-y-1 pl-5">
                ...
                <p className="text-red-400 mt-2">Nezahŕňa: bleskozvod, revízne doklady, montáž zásuviek/svietidiel</p>
              </div>
            </details>
          </div>

          {/* Poznámky - Voda a kanalizácia */}
          <div className="p-3 border-t border-slate-700/50">
            <details className="group">
              <summary className="flex items-center gap-2 cursor-pointer text-xs font-semibold text-blue-400 hover:text-blue-300">
              ...
              <div className="mt-2 text-[10px] text-slate-400 space-y-1 pl-5">
                ...
                <p className="text-red-400 mt-2">Protokoly a sanitárne zariadenia za príplatok</p>
              </div>
            </details>
          </div>
          ...
          <div className="p-3 border-t border-slate-700/50">
            <details className="group">
              ...
              <div className="mt-2 text-[10px] text-slate-400 space-y-1 pl-5">
                ...
                <p className="text-red-400 mt-2">Prípravné práce nie sú v cene</p>
              </div>
            </details>
          </div>
          ...
          <div className="p-3 border-t border-slate-700/50">
            <details className="group">
              ...
              <div className="mt-2 text-[10px] text-slate-400 space-y-1 pl-5">
                ...
                <p className="text-red-400 mt-2">Maľovanie: 4,5 €/m², farbu dodáva klient</p>
              </div>
            </details>
          </div>
        </Card>
