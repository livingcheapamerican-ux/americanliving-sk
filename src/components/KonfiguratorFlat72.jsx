...
export default function KonfiguratorFlat72({ 
  ...
  const selectedItems = useMemo(() => {
    ...
    const izolaciaPrice = izolaciaNavysenie === "ultra" ? 11063 : izolaciaNavysenie === "premium" ? 5900 : izolaciaNavysenie === "zvysena" ? 2950 : 0;
            ...
            <div className="p-3 border-b-2 border-slate-300 bg-slate-50">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="text-base font-black text-gray-900">{dom?.nazov || 'Flat 72m²'}</h3>
                </div>
              </div>
            </div>
        ...
        <div className="p-3 sm:p-6 bg-gradient-to-b from-blue-50/50 to-white">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-3">
            ...
            <div className="col-span-2 sm:col-span-2 grid grid-cols-2 gap-2 sm:gap-3 p-4 border-[5px] border-yellow-500 rounded-2xl bg-yellow-100/70 shadow-xl">
              ...
              <EditableTile selected={elektroinstalacia} onClick={() => setElektroinstalacia(!elektroinstalacia)} title={t('electrical')} subtitle={t('wiring')} price={`+ ${CENY.elektroinstalacia.toLocaleString('sk-SK')} €`} isPriced={true} t={t} isAdmin={isAdmin} priceKey="elektro_rozvody" onPriceChange={handlePriceChange} />
              ...
              <div className="col-span-2 sm:col-span-2 lg:col-span-2 grid grid-cols-2 gap-2 sm:gap-3 p-4 border-[5px] border-green-600 rounded-2xl bg-green-100/70 shadow-xl">
                ...
                <EditableTile selected={tepelneCerpadlo} onClick={() => setTepelneCerpadlo(!tepelneCerpadlo)} title={t('heatPump')} subtitle="1× vonkajšia / 3× vnútorná" price={`+ ${CENY.tepelneCerpadlo.toLocaleString('sk-SK')} €`} isPriced={true} isA0={true} t={t} isAdmin={isAdmin} priceKey="tepelne_cerpadlo" onPriceChange={handlePriceChange} />
                <EditableTile selected={rekuperacia} onClick={() => setRekuperacia(!rekuperacia)} title={t('recuperation')} subtitle="3ks" price={`+ ${CENY.rekuperacia.toLocaleString('sk-SK')} €`} isPriced={true} isA0={true} t={t} isAdmin={isAdmin} priceKey="rekuperacia" onPriceChange={handlePriceChange} />
              </div>
          ...
          <div className="relative p-3 sm:p-5 md:p-6">
              <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 sm:gap-8">
                <div className="flex-1">
                  ...
                  <h3 className="text-base sm:text-xl font-bold text-gray-900 mb-1">{dom?.nazov || 'Flat 72m²'}</h3>
