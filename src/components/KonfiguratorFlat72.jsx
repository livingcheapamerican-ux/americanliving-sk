...
export default function KonfiguratorFlat72({ 
  ...
  const selectedItems = useMemo(() => {
    ...
    const izolaciaLabel = izolaciaNavysenie === "ultra" ? "Ultra izolácia (300mm)" : izolaciaNavysenie === "premium" ? t('insulationPremium') + " (250mm)" : izolaciaNavysenie === "zvysena" ? t('insulationEnhanced') + " (200mm)" : t('insulationStd');
