...
import { 
  ...
  Square, FileCheck, Package, Hammer, Key, Sparkles, CheckCircle, TreePine
} from "lucide-react";
...
export default function KonfiguratorFlat72({ 
  ...
  const totalPrice = useMemo(() => {
    ...
    return total;
  }, [montazHolodomu, vstupneDvere, izolaciaNavysenie, predlzenie, elektroinstalacia, 
          ...
          <div className="p-3 border-b-2 border-slate-300 bg-slate-50">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-base font-black text-gray-900">{dom?.nazov || 'Flat 72'}</h3>
              </div>
            </div>
          </div>
                ...
                <div className="relative p-4 sm:p-8 md:p-10">
                  <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 sm:gap-8">
                    <div className="flex-1">
                      ...
                      <h3 className="text-xl sm:text-3xl font-bold text-white mb-1 sm:mb-2">{dom?.nazov || 'Flat 72'}</h3>
