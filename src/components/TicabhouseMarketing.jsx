      ...
      <div className="p-6 sm:p-10 max-w-6xl mx-auto space-y-12">
        ...
        <div className="space-y-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <FeatureCard 
              ...
              title={t('ticabBenefit1Title')}
              desc={t('ticabBenefit1Desc')}
            />
            <FeatureCard 
              icon={<ShieldCheck className="w-6 h-6 text-blue-400" />}
              title={t('ticabBenefit2Title')}
              desc={t('ticabBenefit2Desc')}
            />
            <FeatureCard 
              icon={<Leaf className="w-6 h-6 text-green-400" />}
              title={t('ticabBenefit3Title')}
              desc={t('ticabBenefit3Desc')}
            />
            <FeatureCard 
              icon={<Blocks className="w-6 h-6 text-amber-400" />}
              title={t('ticabBenefit4Title')}
              desc={t('ticabBenefit4Desc')}
            />
            <FeatureCard 
              icon={<Rocket className="w-6 h-6 text-purple-400" />}
              title={t('ticabBenefit5Title')}
              desc={t('ticabBenefit5Desc')}
            />
            <FeatureCard 
              icon={<HeartHandshake className="w-6 h-6 text-red-400" />}
              title={t('ticabBenefit6Title')}
              desc={t('ticabBenefit6Desc')}
            />
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center bg-white/5 rounded-2xl p-6 border border-white/5">
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-white">{t('ticabContactTitle')}</h3>
            ...
            <ul className="space-y-3 mt-4">
              <li className="flex items-start gap-3 text-sm text-slate-300">
                ...
                <span><strong className="text-white">{t('ticabContactItem1Bold')}</strong>{t('ticabContactItem1Text')}</span>
              </li>
              <li className="flex items-start gap-3 text-sm text-slate-300">
                <CheckCircle2 className="w-5 h-5 text-emerald-500 flex-shrink-0" />
                <span><strong className="text-white">{t('ticabContactItem2Bold')}</strong>{t('ticabContactItem2Text')}</span>
              </li>
              <li className="flex items-start gap-3 text-sm text-slate-300">
                <CheckCircle2 className="w-5 h-5 text-emerald-500 flex-shrink-0" />
                <span><strong className="text-white">{t('ticabContactItem3Bold')}</strong>{t('ticabContactItem3Text')}</span>
              </li>
            </ul>
          </div>
          <div className="relative aspect-video rounded-xl overflow-hidden bg-slate-900 border border-white/10 flex items-center justify-center">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
              ...
              <span className="text-sm font-bold text-emerald-400 mt-1 uppercase tracking-widest">{t('ticabPartner')}</span>
            </div>
          </div>
        </div>
        ...
        <div className="text-center max-w-4xl mx-auto space-y-6">
          <h3 className="text-xl font-bold text-white">{t('ticabPortfolioTitle')}</h3>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 text-left">
            <div className="bg-slate-900/50 p-4 rounded-xl border border-white/5">
              <h4 className="font-bold text-white mb-1">{t('ticabPortfolioItem1Title')}</h4>
              <p className="text-xs text-slate-400">{t('ticabPortfolioItem1Desc')}</p>
            </div>
            <div className="bg-slate-900/50 p-4 rounded-xl border border-white/5">
              <h4 className="font-bold text-white mb-1">{t('ticabPortfolioItem2Title')}</h4>
              <p className="text-xs text-slate-400">{t('ticabPortfolioItem2Desc')}</p>
            </div>
            <div className="bg-slate-900/50 p-4 rounded-xl border border-white/5">
              <h4 className="font-bold text-white mb-1">{t('ticabPortfolioItem3Title')}</h4>
              <p className="text-xs text-slate-400">{t('ticabPortfolioItem3Desc')}</p>
            </div>
            <div className="bg-slate-900/50 p-4 rounded-xl border border-white/5">
              <h4 className="font-bold text-white mb-1">{t('ticabPortfolioItem4Title')}</h4>
              <p className="text-xs text-slate-400">{t('ticabPortfolioItem4Desc')}</p>
            </div>
          </div>
        </div>
