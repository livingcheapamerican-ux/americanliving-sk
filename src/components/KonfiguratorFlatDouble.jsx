...
export default function KonfiguratorFlatDouble({ 
  ...
  const DEFAULT_CENY = {
    ...
    inziniering: 2590,
    projektA0: 3500,
    interierFinis: { ziadne: 0, drevo: 16800, sadrokarton: 19580 },
    vonkajsiaFasada: { standard: 0, suchana: 12843 },
    povrchokaOkien: 3200,
    vnutornePodlahy: 3415,
    podlahovVykurovanie: 5527,
    pergola: 1845,
            ...
            <Card className="overflow-hidden border-2 border-amber-300 shadow-lg">
              ...
              <div className="p-1.5 sm:p-6 bg-gradient-to-b from-amber-50/50 to-white">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-1.5 sm:gap-3">
                 ...
                 {/* Montáž - skupina */}
                 <div className="col-span-2 lg:col-span-1 grid grid-cols-1 gap-1 sm:gap-2 p-1.5 sm:p-3 border-[2px] sm:border-[4px] border-amber-600 rounded-lg sm:rounded-xl bg-amber-100/70 shadow-xl">
                    <p className="text-[8px] sm:text-[10px] font-bold text-amber-700 -mb-0.5 sm:-mb-1 flex items-center gap-0.5 sm:gap-1">
                    ...
                    <EditableTile
                      ...
                      title={t('assemblyYes')}
                      subtitle={t('phase1')}
                      price={`+ ${(17970).toLocaleString('sk-SK')} €`}
                      isPriced={true}
                      t={t}
                      isAdmin={isAdmin}
                      priceKey="montaz_ano"
                  ...
                  {/* Izolácia - skupina */}
                  <div className="col-span-2 lg:col-span-2 p-1.5 sm:p-3 border-[2px] sm:border-[4px] border-cyan-600 rounded-lg sm:rounded-xl bg-cyan-100/70 shadow-xl">
                    ...
                    <div className="grid grid-cols-2 gap-1 sm:gap-2">
                      ...
                      <EditableTile
                        ...
                        title="200/250mm"
                        subtitle="200/250mm"
                        price={`+ ${(5800).toLocaleString('sk-SK')} €`}
                        isPriced={true}
                        t={t}
                        isAdmin={isAdmin}
                      ...
                      <EditableTile
                        ...
                        title="250/300mm"
                        subtitle="250/300mm"
                        price={`+ ${(11600).toLocaleString('sk-SK')} €`}
                        isPriced={true}
                        isA0={true}
                        t={t}
                        isAdmin={isAdmin}
                      ...
                      <EditableTile
                        ...
                        price={`+ ${(21750).toLocaleString('sk-SK')} €`}
                        isPriced={true}
                        isA0={true}
                        t={t}
                        isAdmin={isAdmin}
                  ...
                  {/* Základy - skupina */}
                  <div className="col-span-2 lg:col-span-1 grid grid-cols-2 gap-1 sm:gap-2 p-1.5 sm:p-3 border-[2px] sm:border-[4px] border-orange-600 rounded-lg sm:rounded-xl bg-orange-100/70 shadow-xl">
                    <p className="col-span-2 text-[8px] sm:text-[10px] font-bold text-orange-700 -mb-0.5 sm:-mb-1 flex items-center gap-0.5 sm:gap-1">
                    ...
                    <EditableTile
                      ...
                      price={`+ ${(8141).toLocaleString('sk-SK')} €`}
                      isPriced={true}
                      t={t}
                      isAdmin={isAdmin}
                    ...
                    <EditableTile
                      ...
                      price={`+ ${(18000).toLocaleString('sk-SK')} €`}
                      isPriced={true}
                      t={t}
                      isAdmin={isAdmin}
                    ...
                    <EditableTile
                      ...
                      price={`+ ${(15500).toLocaleString('sk-SK')} €`}
                      isPriced={true}
                      t={t}
                      isAdmin={isAdmin}
