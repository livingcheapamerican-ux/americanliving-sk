...
export default function KonfiguratorFlatDouble({ 
  ...
  const DEFAULT_CENY = {
    ...
    inziniering: 2590,
    projektA0: 3500,
    interierFinis: { ziadne: 0, drevo: 16400, sadrokarton: 19580 },
                ...
                <div className="relative p-3 sm:p-5 md:p-6">
                  <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 sm:gap-8">
                    <div className="flex-1">
                      ...
                      <h3 className="text-base sm:text-xl font-bold text-gray-900 mb-1">{dom?.nazov || 'Flat Double 142m²'}</h3>
