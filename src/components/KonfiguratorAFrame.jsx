...
export default function KonfiguratorAFrame({ 
  ...
  // A-FRAME CENNÍK - FIXNÉ CENY (podľa obrázkov)
  const CENY = {
    montaz: { nie: 0, ano: 5675 },
    predlzenie: { 0: 0, 1.2: 3550, 2.4: 7100, 3.6: 10649, 4.8: 14189 },
    ...
    rekuperacia: 1100,
    zaklady: { bez: 0, skrutky: 3348, doska: 6795, pasove: 7130 },
    pripojkaSiete: 1501,
    inziniering: 2592,
    projektA0: 3500,
