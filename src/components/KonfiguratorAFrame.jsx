                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-1.5 sm:gap-3">
                    ...
                    <div className="col-span-1 sm:col-span-2 grid grid-cols-2 gap-1 sm:gap-2 p-1.5 sm:p-3 border-[2px] sm:border-[4px] border-amber-600 rounded-lg sm:rounded-xl bg-amber-100/70 shadow-xl">
                      ...
                      <EditableTile
                        ...
                        title={t('assemblyYes')}
                        subtitle={t('phase1')}
                        price={`+ ${(5675).toLocaleString('sk-SK')} €`}
                        isPriced={true}
                        t={t}
                        isAdmin={isAdmin}
                        priceKey="montaz_ano"
                    ...
                    <div className="col-span-1 sm:col-span-3 lg:col-span-4 p-1.5 sm:p-3 border-[2px] sm:border-[4px] border-cyan-600 rounded-lg sm:rounded-xl bg-cyan-100/70 shadow-xl">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-1 sm:gap-2">
                        ...
                        <EditableTile
                          ...
                          title="200/250mm"
                          subtitle="200/250mm"
                          price={`+ ${(1600).toLocaleString('sk-SK')} €`}
                          isPriced={true}
                          t={t}
                          isAdmin={isAdmin}
                        ...
                        <EditableTile
                          ...
                          price={`+ ${(6000).toLocaleString('sk-SK')} €`}
                          isPriced={true}
                          isA0={true}
                          t={t}
                          isAdmin={isAdmin}
                    ...
                    <div className="col-span-1 sm:col-span-3 lg:col-span-4 grid grid-cols-2 sm:grid-cols-4 gap-1 sm:gap-2 p-1.5 sm:p-3 border-[2px] sm:border-[4px] border-orange-600 rounded-lg sm:rounded-xl bg-orange-100/70 shadow-xl">
                      ...
                      <EditableTile
                        ...
                        price={`+ ${(2100).toLocaleString('sk-SK')} €`}
                        isPriced={true}
                        t={t}
                        isAdmin={isAdmin}
                      ...
                      <EditableTile
                        ...
                        price={`+ ${(7000).toLocaleString('sk-SK')} €`}
                        isPriced={true}
                        t={t}
                        isAdmin={isAdmin}
                      ...
                      <div className="col-span-1 sm:col-span-3 lg:col-span-4 p-1.5 sm:p-3 border-[2px] sm:border-[4px] border-indigo-600 rounded-lg sm:rounded-xl bg-indigo-100/70 shadow-xl">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-5 gap-1 sm:gap-2">
                          {[
                            ...
                            { value: 1.2, label: "+1,2 m", price: 3300 },
                            { value: 2.4, label: "+2,4 m", price: 6606 },
                            { value: 3.6, label: "+3,6 m", price: 9900 },
                            { value: 4.8, label: "+4,8 m", price: 15880 }
                          ].map((opt) => (
                            <EditableTile
                              key={opt.value}
                ...
                <div className="relative p-4 sm:p-8 md:p-10">
                  <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 sm:gap-8">
                    <div className="flex-1">
                      ...
                      <h3 className="text-xl sm:text-3xl font-bold text-white mb-1 sm:mb-2">{dom?.nazov || 'A-Frame'}</h3>
