                ...
                <Card className="overflow-hidden border-2 border-blue-300 shadow-lg">
                  ...
                  <div className="p-2 sm:p-3 bg-gradient-to-b from-blue-50/50 to-white">
                    ...
                    <div className="col-span-2 sm:col-span-3 grid grid-cols-3 gap-1.5 sm:gap-2 p-2 sm:p-3 border-[3px] sm:border-[4px] border-blue-600 rounded-xl bg-blue-100/70 shadow-xl">
                      ...
                      <Tile selected={interierFinis === "drevo"} onClick={() => setInterierFinis("drevo")} icon={Home} iconColor="text-amber-600" iconSelectedColor="text-blue-600" title={t('interiorWood')} subtitle={t('woodCladding')} price="+ 18 000 €" isPriced={true} tooltip={t('interiorWood')} />
                      <Tile selected={interierFinis === "sadrokarton"} onClick={() => setInterierFinis("sadrokarton")} icon={Home} iconColor="text-gray-500" iconSelectedColor="text-blue-600" title={t('interiorDrywall')} subtitle={t('plaster')} price="+ 21 086 €" isPriced={true} tooltip={t('interiorDrywall')} />
                    </div>
                    ...
                    <div className="col-span-2 sm:col-span-3 lg:col-span-4 grid grid-cols-2 sm:grid-cols-4 gap-1.5 sm:gap-2 p-2 sm:p-3 border-[3px] sm:border-[4px] border-yellow-500 rounded-xl bg-yellow-100/70 shadow-xl">
                      ...
                      <Tile selected={elektroinstalacia} onClick={() => setElektroinstalacia(!elektroinstalacia)} icon={Zap} iconColor="text-yellow-500" iconSelectedColor="text-yellow-600" title={t('electrical')} subtitle={t('wiring')} price="+ 7 800 €" isPriced={true} selectedBg="bg-yellow-100" selectedBorder="border-yellow-500" selectedRing="ring-yellow-300" hoverBorder="hover:border-yellow-300" tooltip={t('electricalFull')} />
                      <Tile selected={vodaKanalizacia} onClick={() => setVodaKanalizacia(!vodaKanalizacia)} icon={Droplets} iconColor="text-blue-400" iconSelectedColor="text-blue-600" title={t('water')} subtitle="Rozvody + kanalizácia" price="+ 3 650 €" isPriced={true} tooltip={t('waterFull')} />
                    ...
                    <div className="col-span-2 sm:col-span-2 lg:col-span-2 grid grid-cols-2 gap-1.5 sm:gap-2 p-2 sm:p-3 border-[3px] sm:border-[4px] border-green-600 rounded-xl bg-green-100/70 shadow-xl">
                      ...
                      <Tile selected={tepelneCerpadlo} onClick={() => setTepelneCerpadlo(!tepelneCerpadlo)} icon={ThermometerSun} iconColor="text-red-500" iconSelectedColor="text-green-600" title={t('heatPump')} subtitle="1× vonk. / 4× vn." price="+ 3 600 €" isPriced={true} isA0={true} selectedBg="bg-green-100" selectedBorder="border-green-500" selectedRing="ring-green-300" tooltip={t('heatPumpFull')} />
                      <Tile selected={rekuperacia} onClick={() => setRekuperacia(!rekuperacia)} icon={Wind} iconColor="text-cyan-500" iconSelectedColor="text-green-600" title={t('recuperation')} subtitle="7 ks" price="+ 7 749 €" isPriced={true} isA0={true} selectedBg="bg-green-100" selectedBorder="border-green-500" selectedRing="ring-green-300" tooltip={t('recuperation')} />
                    </div>
                ...
                <div className="p-2 sm:p-3 bg-gradient-to-b from-emerald-50/50 to-white">
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-1.5 sm:gap-2">
                    <div className={`col-span-2 grid grid-cols-2 gap-1.5 sm:gap-2 p-2 sm:p-3 border-[3px] sm:border-[4px] rounded-xl shadow-xl ${!vonkajsiaFasada ? 'border-red-600 bg-red-100/70 animate-pulse' : 'border-emerald-600 bg-emerald-100/70'}`}>
                      ...
                      <Tile selected={vonkajsiaFasada === "suchana"} onClick={() => setVonkajsiaFasada("suchana")} icon={Paintbrush} iconColor="text-orange-400" iconSelectedColor="text-emerald-600" title={t('facadeStucco')} subtitle={t('whitePlaster')} price="+ 12 211 €" isPriced={true} selectedBg="bg-emerald-100" selectedBorder="border-emerald-500" selectedRing="ring-emerald-300" hoverBorder="hover:border-emerald-300" tooltip={t('facadeStucco')} />
                    </div>

                    <Tile selected={vnutornePodlahy} onClick={() => setVnutornePodlahy(!vnutornePodlahy)} icon={Square} iconColor="text-amber-500" iconSelectedColor="text-emerald-600" title={t('floors')} subtitle={t('floorsLaminate')} price="+ 3 415 €" isPriced={true} selectedBg="bg-emerald-100" selectedBorder="border-emerald-500" selectedRing="ring-emerald-300" hoverBorder="hover:border-emerald-300" tooltip={t('floors')} />
