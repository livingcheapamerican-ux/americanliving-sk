...
export default function KonfiguratorFjord({ 
  ...
  const CENY = useMemo(() => ({
    ...
    izolacia: { 
      ...
      extra: getPrice('izolacia_extra') ?? DEFAULT_CENY.izolacia.extra,
      "300mm": getPrice('izolacia_300mm') ?? DEFAULT_CENY.izolacia["300mm"]
    },
                  ...
                  <div className="relative p-3 sm:p-5 md:p-6">
                    ...
                    <div className="mt-6 sm:mt-10 pt-4 sm:pt-8 border-t border-slate-700/50 flex justify-start">
                      <Button 
                        size="lg" 
                        onClick={() => setShowContactModal(true)}
                        className="bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 hover:from-green-600 hover:via-emerald-600 hover:to-teal-600 text-white font-bold text-sm sm:text-lg px-6 sm:px-12 py-4 sm:py-7 shadow-2xl shadow-green-500/30 transition-all hover:scale-105 hover:shadow-green-500/40"
                      >
