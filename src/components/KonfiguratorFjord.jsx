            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }}>
                <Card className="overflow-hidden border-2 border-blue-300 shadow-lg">
                  ...
                  <div className="p-2 sm:p-3 bg-gradient-to-b from-blue-50/50 to-white">
                    ...
                    <Tile selected={pripojkaSiete} onClick={() => setPripojkaSiete(!pripojkaSiete)} icon={Cable} iconColor="text-blue-600" iconSelectedColor="text-blue-800" title={t('gridConnection')} subtitle={t('connection')} price={`+ ${CENY.pripojkaSiete.toLocaleString('sk-SK')} €`} isPriced={true} isAdmin={isAdmin} priceKey="pripojkaSiete" onPriceChange={handlePriceChange} />
                     <Tile selected={povrchokaOkien} onClick={() => setPovrchokaOkien(!povrchokaOkien)} icon={Sun} iconColor="text-blue-600" iconSelectedColor="text-blue-800" title={t('lamination')} subtitle={t('laminationAnthracite')} price={`+ ${CENY.povrchokaOkien.toLocaleString('sk-SK')} €`} isPriced={true} isAdmin={isAdmin} priceKey="povrchokaOkien" onPriceChange={handlePriceChange} />
                     <Tile selected={tonovaneSkla} onClick={() => setTonovaneSkla(!tonovaneSkla)} icon={Sun} iconColor="text-blue-600" iconSelectedColor="text-blue-800" title={t('tintedGlass')} subtitle={t('solarGlass')} price={`+ ${CENY.tonovaneSkla.toLocaleString('sk-SK')} €`} isPriced={true} isAdmin={isAdmin} priceKey="tonovaneSkla" onPriceChange={handlePriceChange} />
                  </div>
                ...
                <div className="p-2 sm:p-3 bg-gradient-to-b from-emerald-50/50 to-white">
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-1.5 sm:gap-2">
                    <div className={`col-span-2 grid grid-cols-2 gap-1.5 sm:gap-2 p-2 sm:p-3 border-[3px] sm:border-[4px] rounded-xl shadow-xl ${!vonkajsiaFasada ? 'border-red-600 bg-red-100/70 animate-pulse' : 'border-emerald-600 bg-emerald-100/70'}`}>
                      ...
                      <Tile selected={vonkajsiaFasada === "standard"} onClick={() => setVonkajsiaFasada("standard")} icon={Paintbrush} iconColor="text-emerald-600" iconSelectedColor="text-emerald-800" title={t('facadeWoodMetal')} subtitle={t('facadeStandard')} price="0 €" isPriced={false} isAdmin={false} />
                ...
                <div className="p-2 sm:p-3 bg-gradient-to-b from-purple-50/50 to-white">
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-1.5 sm:gap-2">
                    <Tile selected={inziniering} onClick={() => setInziniering(!inziniering)} icon={FileCheck} iconColor="text-purple-600" iconSelectedColor="text-purple-800" title={t('engineering')} subtitle={t('buildingPermit')} price={`+ ${CENY.inziniering.toLocaleString('sk-SK')} €`} isPriced={true} isAdmin={isAdmin} priceKey="inziniering" onPriceChange={handlePriceChange} />
                     ...
                     <Tile selected={revizna} onClick={() => setRevizna(!revizna)} icon={FileCheck} iconColor="text-purple-600" iconSelectedColor="text-purple-800" title={t('revision')} subtitle={t('documentation')} price={`+ ${CENY.revizna.toLocaleString('sk-SK')} €`} isPriced={true} isAdmin={isAdmin} priceKey="revizna" onPriceChange={handlePriceChange} />
                     <Tile selected={doprava} onClick={() => setDoprava(!doprava)} icon={Truck} iconColor="text-purple-600" iconSelectedColor="text-purple-800" title={t('transport')} subtitle={t('transportFull')} price="0 €" isPriced={false} isAdmin={false} />
                  </div>
