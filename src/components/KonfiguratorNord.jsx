...
export default function KonfiguratorNord({ 
  ...
  const CENY = {
    ...
    povrchokaOkien: 3100,
    vnutornePodlahy: 3400,
    podlahovVykurovanie: 5100,
    pergola: 1845,
    interieroveDvere: 1760,
    tonovaneSkla: 2680,
    doprava: 1500,
    revizna: 1000,
    stresneOkno: 1500,
    bocneOknoFixne: 1680,
    bocneOknoVyklopne90: 1680,
    bocneOknoVyklopne55: 1680
  };
              ...
              <Card className="overflow-hidden border-2 border-blue-300 shadow-lg">
                ...
                <div className="p-3 sm:p-6 bg-gradient-to-b from-blue-50/50 to-white">
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-3">
                    ...
                    <Tile selected={tonovaneSkla} onClick={(e) => { if (!tonovaneSkla) triggerAnimation("oknoTonovane", e.currentTarget); setTonovaneSkla(!tonovaneSkla); }} icon={Sun} iconColor="text-amber-400" iconSelectedColor="text-amber-600" title={t('tintedGlass')} subtitle={t('solarGlass')} price="+ 2 680 €" isPriced={true} selectedBg="bg-amber-100" selectedBorder="border-amber-500" selectedRing="ring-amber-300" hoverBorder="hover:border-amber-300" tooltip={t('tintedGlass')} />
                  </div>
                  ...
                  <div className="mt-4 p-3 sm:p-4 bg-white rounded-xl border-2 border-gray-200">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                      {[
                        { state: stresneOkno, setter: setStresneOkno, label: t('roofWindow'), price: "1 500 €" },
                        { state: bocneOknoFixne, setter: setBocneOknoFixne, label: `${t('fixedWindow')} 90×205`, price: "1 680 €" },
                        { state: bocneOknoVyklopne90, setter: setBocneOknoVyklopne90, label: `${t('tiltWindow')} 90×205`, price: "1 680 €" },
                        { state: bocneOknoVyklopne55, setter: setBocneOknoVyklopne55, label: `${t('tiltWindow')} 55×90`, price: "1 680 €" }
                      ].map((opt, idx) => (
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <span className="text-green-600 font-bold text-xs ml-2">× 1 760 €</span>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
