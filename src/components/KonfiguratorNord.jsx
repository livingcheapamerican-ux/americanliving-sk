              ...
              <Card className="overflow-hidden border-2 border-amber-300 shadow-lg">
                ...
                <div className="p-1.5 sm:p-6 bg-gradient-to-b from-amber-50/50 to-white">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-1.5 sm:gap-3">
                    ...
                    {/* Izolácia - skupina */}
                    <div className="col-span-1 sm:col-span-3 lg:col-span-4 grid grid-cols-2 gap-1 sm:gap-2 p-1.5 sm:p-3 border-[2px] sm:border-[4px] border-cyan-600 rounded-lg sm:rounded-xl bg-cyan-100/70 shadow-xl auto-rows-max">
                      <p className="col-span-2 text-[8px] sm:text-[10px] font-bold text-cyan-700 -mb-0.5 sm:-mb-1 flex items-center gap-0.5 sm:gap-1">
