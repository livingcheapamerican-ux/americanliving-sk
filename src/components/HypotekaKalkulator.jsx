...
export default function HypotekaKalkulator({ 
  ...
  // Použiť cenu z konfiguratora ak je dostupná, inak fallback
  const aktCena = celkovaCenaZKonfiguratora || aktualnaKonfiguracia?.celkovaCena || cenaDoma || 100000;
