      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.div
            ...
            className={`fixed right-4 z-40 ${isKonfigurator ? 'bottom-24 sm:bottom-8' : 'bottom-6 sm:bottom-8'} sm:right-6`}
          >
            <button
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-4 right-2 left-2 sm:left-auto sm:bottom-6 sm:right-4 z-40 sm:w-[420px]"
          >
