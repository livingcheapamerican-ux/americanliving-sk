    ...
    <Card className="p-6 bg-white shadow-xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm font-semibold text-gray-900">Vypočítajte si orientačnú cenu</p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-blue-50 border border-blue-300 rounded-lg p-4">
          <div className="flex justify-between items-center">
            <span className="font-bold text-gray-900">Základná cena domu</span>
        ...
        <div className="border-b border-gray-300 pb-4">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-3">
              <Checkbox 
                ...
                id="montaz"
              />
              <Label htmlFor="montaz" className="font-bold cursor-pointer text-gray-900">
                Montáž domu
              </Label>
            </div>
          ...
          <p className="text-sm font-medium text-gray-800 ml-8">Kompletná montáž na pozemku</p>
        </div>

        {/* Fasáda */}
        <div className="border-b border-gray-300 pb-4">
          <Label className="font-bold mb-3 block text-gray-900">Vonkajšia fasáda</Label>
              ...
              {Object.entries(cennik.fasada).map(([key, price]) => (
                <div key={key} className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <Label htmlFor={`fasada-${key}`} className="cursor-pointer font-semibold text-gray-900">
        ...
        {/* Základy */}
        <div className="border-b border-gray-300 pb-4">
          <Label className="font-bold mb-3 block text-gray-900">Základy</Label>
              ...
              {Object.entries(cennik.zaklady).map(([key, price]) => (
                <div key={key} className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <Label htmlFor={`zaklady-${key}`} className="cursor-pointer font-semibold text-gray-900">
        ...
        <div className="space-y-3">
          <Label className="font-bold text-gray-900">Inštalácie a technológie</Label>
          {[
        ...
        <div className="space-y-3 border-t border-gray-300 pt-4">
          <Label className="font-bold text-gray-900">Dokumentácia a certifikáty</Label>
          {[
        ...
        {/* Info */}
        <div className="bg-amber-50 border-2 border-amber-400 rounded-lg p-4 flex gap-3">
