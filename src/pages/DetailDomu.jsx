...
import KonfiguratorLyon, { LyonSummaryPanel } from "../components/KonfiguratorLyon";
import React from "react";

// Wrapper pre Lyon konfigurátor s oddelením sidebaru
function LyonKonfiguratorWrapper() {
  const BASE_PRICE = 73431;
  
  const [ucel, setUcel] = React.useState("chata");
  const [kolaudacia, setKolaudacia] = React.useState("bez_a0");
