...
export default function DetailDomu() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 overflow-x-hidden max-w-full">
      ...
      <div className="container mx-auto px-2 sm:px-4 max-w-full overflow-hidden" style={{ paddingTop: '0.5rem', paddingBottom: '1.5rem' }}>
        <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 w-full max-w-full overflow-hidden">
          ...
          >
            ...
            {/* Konfigurátor pre Nord - ľavá strana (plný konfigurátor) */}
